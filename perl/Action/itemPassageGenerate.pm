  ...
  if ( $in{myAction} eq 'create' ) {
    ...
    foreach my $formatKey ( grep /^formatCount/, keys %in ) {
      ...
      for ( my $i = 0 ; $i < $in{$formatKey} ; $i++ ) {
        ...
        $item->create( $in{itemBank}, '', undef, $writerCode  );
...
sub print_first_screen {
    ...
    my $gradeLevelHtml =  &hashToSelect( 'gradeLevel', $const[$OC_GRADE_LEVEL], $gradeLevel, '', '', '', 'font-size:11px;');
...
<html>
  ...
  <body>
    ...
    <table border="0" cellpadding="4" cellspacing="4">
      ...
      <tr><td><span class="text">Subject:</span></td>
          <td>${contentAreaHtml}</td></tr>
      <tr><td><span class="text">Grade Level:</span></td>
...
<html>
  ...
  <body >
    ...
    <table class="standards" border="0" cellpadding="2" cellspacing="2">
      ...
      <tr><td><span class="text">Subject:</span></td><td>${contentAreaName}</td></tr> 
      <tr><td><span class="text">Grade Level:</span></td><td>${gradeLevelName}</td></tr> 
