...
public class ItemAlternateServices implements Serializable {
    ...
    private static final Log LOGGER = LogFactory
            .getLog(ItemAlternateServices.class);
    ...
    /**
     * @param id
     *            int representing the primary key of the {@link ItemAlternate}
    ...
    /**
     * @param itemId
     *            int representing the {@link Item#getId()}
     ...
     *            {@link ItemAlternate#getAlternateItemId()} or
     *            {@link Item#getId()}
     * @return {@link ItemAlternate}; may return null if the {@link Item} is not
     *         an alternate.
     */
    public ItemAlternate findByAlternateItemId(long itemAlternateId) {
        ...
        Query query = entityManager
                .createNamedQuery("alternateByAlternateItemId");
        ...
        try {
            ...
            LOGGER.error("Unable to fid Item Alternate " + nre.getMessage(),
                    nre);
        }
