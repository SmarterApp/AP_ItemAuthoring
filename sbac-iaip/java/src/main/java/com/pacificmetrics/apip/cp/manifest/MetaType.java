 ...
 *       &lt;sequence>
 *         &lt;element name="guid" type="{http://pacificmetrics.com/apip/cp/manifest}guidType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class MetaType {
     ...
     * 
     */
    public List<GuidType> getGuids() {
        if (guids == null) {
            guids = new ArrayList<GuidType>();
        }
        return this.guids;
    }
