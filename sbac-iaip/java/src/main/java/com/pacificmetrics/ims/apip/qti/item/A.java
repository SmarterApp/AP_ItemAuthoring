 ...
 *         &lt;/choice>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtiitem/imsqti_v2p2}class.A.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtiitem/imsqti_v2p2}xmlbase.A.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtiitem/imsqti_v2p2}type.A.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtiitem/imsqti_v2p2}id.A.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtiitem/imsqti_v2p2}label.A.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtiitem/imsqti_v2p2}xmllang.A.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtiitem/imsqti_v2p2}href.A.Attr"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class A {
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Gap }
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >} {@link String }
	 * {@link EndAttemptInteraction } {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link TemplateInline } {@link JAXBElement }
	 * {@code <}{@link HTMLTextType }{@code >} {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link PrintedVariable } {@link Math }
	 * {@link CustomInteraction } {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link FeedbackInline } {@link Hottext }
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 ...
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link TextEntryInteraction } {@link Img } {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link InlineChoiceInteraction }
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * 
