...
/**
 * 
 * A rubric block identifies instructions to one or more of the actors that view
 * the item or set of items (as per a section). Although rubric blocks are
 * defined as simpleBlocks they must not contain interactions. The visibility of
 * nested bodyElements or rubricBlocks is determined by the outermost element.
 * In other words, if an element is determined to be hidden then all of its
 * content is hidden including conditionally visible elements for which the
 * conditions are satisfied and that therefore would otherwise be visible.
 ...
 * 
 * <p>
 * Java class for RubricBlock.Type complex type.
 * 
 * <p>
 ...
 *         &lt;/choice>
 *         &lt;element ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2}stylesheet" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/imsapip_qtiv1p0}apipAccessibility" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2}xmllang.RubricBlock.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2}label.RubricBlock.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2}id.RubricBlock.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2}class.RubricBlock.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2}view.RubricBlock.Attr"/>
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2}xmlbase.RubricBlock.Attr"/>
 *       &lt;attribute name="use">
 *         &lt;simpleType>
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *             &lt;enumeration value="scoringguidance"/>
 *             &lt;enumeration value="sharedstimulus"/>
...
@XmlType(name = "RubricBlock.Type", propOrder = { "content" })
...
public class RubricBlock {
	...
	@XmlElementRefs({
			...
			@XmlElementRef(name = "stylesheet", namespace = "http://www.imsglobal.org/xsd/apip/apipv1p0/qtisection/imsqti_v2p2", type = Stylesheet.class, required = false),
	...
	/**
	 * 
	 * A rubric block identifies instructions to one or more of the actors that
	 * view the item or set of items (as per a section). Although rubric blocks
	 * are defined as simpleBlocks they must not contain interactions. The
	 * visibility of nested bodyElements or rubricBlocks is determined by the
	 * outermost element. In other words, if an element is determined to be
	 * hidden then all of its content is hidden including conditionally visible
	 * elements for which the conditions are satisfied and that therefore would
	 * otherwise be visible. [APIP-Section (Core)] Profile - the changes to the
	 * XML attribute list are: * The "use" attribute class type has been changed
	 * to the class "UseType"; Gets the value of the content property.
	 * 
	 * <p>
	 ...
	 * {@link JAXBElement }{@code <}{@link OULType }{@code >} {@link Q }
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >} {@link Math }
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >} {@link Br }
	 ...
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link Stylesheet } {@link JAXBElement }{@code <}{@link HTMLTextType }
	 * {@code >} {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 ...
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link OULType }{@code >} {@link Include }
	 * {@link Img } {@link Dl } {@link Div } {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >} {@link Hr } {@link JAXBElement }{@code <}
	 * {@link HTMLTextType }{@code >}
	 * {@link com.pacificmetrics.ims.apip.qti.section.Object } {@link Table }
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
	 * {@link JAXBElement }{@code <}{@link HTMLTextType }{@code >}
