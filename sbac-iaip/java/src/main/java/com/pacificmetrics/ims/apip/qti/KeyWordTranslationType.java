...
@XmlRootElement(name = "keyWordTranslation")
public class KeyWordTranslationType {

    @XmlElement(name = "definitionId", required = true)
    protected List<DefinitionIdType> definitionIds;
     ...
     * This is why there is not a <CODE>set</CODE> method for the definitionIds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDefinitionIds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DefinitionIdType> getDefinitionIds() {
        if (definitionIds == null) {
            definitionIds = new ArrayList<DefinitionIdType>();
        }
