 ...
 *                 [APIP-Manifest] Profile - the changes to the XML element list are:
 *                 * The "source" element has been assigned a new default value of "APIPv1.0";
 *                 * The "source" element class type has been changed to the class "LearningResourceTypeSourceVocab";
 *             
 * 
