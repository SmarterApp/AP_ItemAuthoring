package Action::passageMetafiles;
...
sub run {
  ...
  my $files = $passage->getMetafiles();
  
  my $psgi_out = <<END_HERE;
<!DOCTYPE html>
<html>
  <head>
    <title>Passage Metafiles</title>
  ...
  <body>
    <div class="title">Passage Metafiles</div>
		<p><a href="#" onClick="myOpen('uploadWin','${orcaUrl}cgi-bin/passageMetafileUpload.pl?passageId=$in{passageId}',600,400);">Upload</a>
		</p>
