...
<script type="text/javascript">
   ...
   String hires_image = "/pixenate/images/samples/hires/hongkong.jpg"; 
   if (request.getParameter("hires_image") != null){ 
      hires_image= request.getParameter("hires_image");
   } 
...
<input type="hidden" name="next_page" value="/pixenate/themes/hires/index.jsp"/>
