...
pxn8_original_filename = "<? echo $originalFilename ?>";
PXN8.dom.addLoadEvent(function(){
	PXN8.initialize("<? echo $image ?>");
	/**
...
<?php 
  $hires_image = "/pixenate/images/samples/hires/hongkong.jpg"; 
  if (isset($_GET["hires_image"]))  {
    $hires_image = $_GET["hires_image"];
  }
?>
PXN8.hires.init("<? echo $hires_image ?>");
...
<input type="hidden" name="next_page" value="/pixenate/themes/hires/index.php"/>
