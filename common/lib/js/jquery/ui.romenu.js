...
(function($) {
    $.widget("ui.romenu", {
        ...
        createMenu: function() {
            ...
            if (o.contentType === "json") {
                ...
                jQuery.each(o.content, function(index, value) {
                    tmpList.find("ul").append("<li style=\"text-align:"+o.comboAlign+"\" name=\""+value[1]+"\" alt=\"" + value[0] + "\"><a class=\"dropdownMenuItem\" href=\"#\">" + value[1] + "</a></li>");
                });
            ...
            this.menu.css({ "width": o.dropdownWidth+"px", "white-space": "pre" }).appendTo('body').find('ul:first').not('.fg-menu-breadcrumb').addClass('fg-menu');
            ...
            this.menu.find('a').attr('tabindex', '-1').addClass('dropdownMenuItem');
            ...
            if (this.menu.height() > o.maxHeight) { 
                ...
                this.menu.find("ul").first().width(o.dropdownWidth-15);
            }
        ...
        close: function() {
            ...
            this.onClose();
            for (var i=0; i < $.ui.romenu.manager.length; i++) {
                if ($.ui.romenu.manager[i] == this) {
                    $.ui.romenu.manager.splice(i,1);
                };
            };
        },
