    ...
    alter table JIAdhocChartMeasure 
        drop constraint FK89D1A3FAB0A3C8CB;

    alter table JIAdhocColumn 
        drop constraint FK9265D330EC885ADB;
    ...
    alter table JIAdhocGroup 
        drop constraint FK704D9365EC885ADB;
    ...
    alter table JIAdhocTableSortField 
        drop constraint FK1AF05FA8EC885ADB;

    alter table JIAdhocXTabColumnGroup 
        drop constraint FK336E71F262231DA;

    alter table JIAdhocXTabMeasure 
        drop constraint FK3CF53B0762231DA;

    alter table JIAdhocXTabRowGroup 
        drop constraint FK9D33843C62231DA;
