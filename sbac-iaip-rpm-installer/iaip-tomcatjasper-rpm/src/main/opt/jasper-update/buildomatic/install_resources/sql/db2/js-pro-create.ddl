    ...
    create table JIDataType (
        ...
        minValue varchar(255) for bit data,
        max_value varchar(255) for bit data,
        strictMin smallint,
        strictMax smallint,
        primary key (id)
    );
    ...
    create table JIReportOptionsInput (
        ...
        input_value varchar(1000) for bit data,
    ...
    create index total_report_execution_time_index on JIReportMonitoringFact (total_report_execution_time);
