 ...
 *       &lt;sequence>
 *         &lt;element name="string" type="{http://pacificmetrics.com/apip/cp/manifest}stringType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TypicalAgeRangeType {
    ...
    protected List<StringType> strings;
     ...
     * 
     */
    public List<StringType> getStrings() {
        if (strings == null) {
            strings = new ArrayList<StringType>();
        }
        return this.strings;
    }
