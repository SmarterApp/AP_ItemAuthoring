...
public class PropertyUtil {
    ...
    public static final String FTP_TEMP_PATH = "ftpimp.temp.path";
    public static final String FTP_LOG_PATH = "ftpimp.log.path";
    public static final String FTP_IMS_IMPORT_UPLOAD = "ftpimp.ims.upload";
