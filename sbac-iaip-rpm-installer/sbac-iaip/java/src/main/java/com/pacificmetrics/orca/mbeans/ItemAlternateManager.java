...
public class ItemAlternateManager extends AbstractManager implements
    ...
    private static final Logger LOGGER = Logger
            .getLogger(ItemAlternateManager.class.getName());
    ...
    public void load() {
        ...
        if (itemId != null) {
            // TODO: update itemServices to check whether user has permissions
            // to view item
     ...
     */
    void setSelectedItemAlternateId(int index, Integer selectedItemAlternateId) {
        Item ia = null;
    ...
    public String getViewUrl(Long itemId) {
        ...
        final boolean isOriginalItem = originalItem != null ? itemId
                .equals(originalItem.getId()) : false;
        final boolean isSourceItem = sourceItem != null ? itemId
                .equals(sourceItem.getId()) : false;
        final boolean isAlternateItem = itemAlternateMap
                .containsKey((int) (long) itemId);
    ...
    private Map<Integer, ItemAlternate> populateItemAlternateMap() {
        Map<Integer, ItemAlternate> itemAlternateMapLocal = new HashMap<Integer, ItemAlternate>();
        ...
        for (ItemAlternate ia : itemAlternates) {
            itemAlternateMapLocal.put(ia.getAlternateItemId(), ia);
        }

        return itemAlternateMapLocal;
    }
    ...
    private Map<Integer, Item> populateItemMap() {
        ...
        if (itemAlternateMap.isEmpty()) {
            itemAlternateMap = populateItemAlternateMap();
        }

        Map<Integer, Item> itemMapLocal = new HashMap<Integer, Item>();
        ...
        for (ItemAlternate itemAlternate : itemAlternateMap.values()) {
            ...
            itemMapLocal.put(itemAlternateId, item);
        }
    ...
    private List<SelectItem> populateItemAlternateSelectItems() {
        List<SelectItem> itemAlternateSelectItemsLocal = new ArrayList<SelectItem>();
        ...
        if (sourceItem != null) {
            ...
            itemAlternateSelectItemsLocal.add(si);
