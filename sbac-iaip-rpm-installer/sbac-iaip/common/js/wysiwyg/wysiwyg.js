...
// Images Directory
var imagesDir = "/common/js/wysiwyg/icons/";

// CSS Directory
var cssDir = "/common/js/wysiwyg/styles/";

// Popups Directory
var popupsDir = "/common/js/wysiwyg/popups/";

// WYSIWYG Width and Height
var wysiwygWidth = 500;
var wysiwygHeight = 150;
...
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
  ...
  "paste":          ['Paste',                'Paste',              imagesDir + 'paste.gif',              imagesDir + 'paste_on.gif'],
	...
	"pause":           ['InsertPause',                 'InsertPause',               imagesDir + 'pause_icon.png',               imagesDir + 'pause_on_icon.png'],
...
function generate_wysiwyg(textareaID) {
  ...
  //document.getElementById("wysiwyg" + n).attachEvent('onkeypress', function() { setSaveFlag(); } );
  //document.getElementById("wysiwyg" + n).addEventListener('keypress', function() { setSaveFlag(); }, true);
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      window.open(popupsDir + 'insert_image.html?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=190');
		...
		else if (id == "InsertPause") {
			insertHTML2('<font color="blue">&nbsp;&lt;pause&gt;&nbsp;</font><font color="white"></font>', n);
	  }
...
function insertHTML2(html, n) {
  ...
  var browserName = navigator.appName;
        ...
        if (browserName == "Microsoft Internet Explorer") {
          ...
          var span = document.getElementById('wysiwyg' + n).contentWindow.document.createElement("span");

                span.innerHTML = html;
                var node = insertNodeAtSelection(span, n);
        }
