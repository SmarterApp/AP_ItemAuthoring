...
idlist.btns[0]=new Image(); idlist.btns[0].src="/common/js/popup/min.gif";
idlist.btns[1]=new Image(); idlist.btns[1].src="/common/js/popup/max.gif";
idlist.btns[2]=new Image(); idlist.btns[2].src="/common/js/popup/close.gif";
idlist.btns[3]=new Image(); idlist.btns[3].src="/common/js/popup/resize.gif";
...
if(isresize){
rdiv.innerHTML='<img src="/common/js/popup/resize.gif" width="7" height="7">';
...
titlebar.innerHTML='<span style="position:absolute; left:3px; top:1px; font:bold 10pt sans-serif; color:'+titletextcolor+'; height:18px; overflow:hidden; clip-height:16px;">'+title+'</span><span id="'+cid+'_btt" style="position:absolute; width:48px; height:16px; left:'+(tw-48)+'px; top:2px;"><img src="/common/js/popup/min.gif" width="16" height="16" id="'+cid+'_min"><img src="/common/js/popup/max.gif" width="16" height="16"  id="'+cid+'_max"><img src="/common/js/popup/close.gif" width="16" height="16" id="'+cid+'_cls"></span>';
tw=(ie5)?w-7:w-13;
th=(ie5)?h-36:h-36;
