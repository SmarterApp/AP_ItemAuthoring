...
JRE_LATEST_ORACLE=/usr/java/latest/jre
#echo $JRE_LATEST_ORACLE
JRE_HOME_ORACLE=$(readlink -e $JRE_LATEST_ORACLE)
#echo $JRE_HOME_ORACLE
JAVA_HOME=${JRE_HOME_ORACLE%/jre}
