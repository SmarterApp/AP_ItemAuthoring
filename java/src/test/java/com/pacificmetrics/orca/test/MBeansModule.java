...
public class MBeansModule implements Module {
    ...
    public void init(Properties configuration) {
        System.out.println("mbeans - init");
    }

    @Override
    public void afterInit() {
        System.out.println("mbeans - after init");
    }
    ...
    static private void processTestedManagers(Object testObject) {
    ...
    static private void assignParameters(AbstractManager manager, TestParameter[] testParameters) {
    ...
    static private void injectMessageContext(AbstractManager manager) {
