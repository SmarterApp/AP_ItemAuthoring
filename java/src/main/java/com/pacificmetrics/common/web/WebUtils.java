...
public class WebUtils {
    ...
    static public void addStyle(UIComponent component, String styleToAdd) {
    ...
    static public void removeStyle(UIComponent component, String styleToRemove) {
        String styles = (String)component.getAttributes().get("styleClass");
    ...
    static public void sendFileToDownload(String fileName, byte[] bytes) throws IOException {
